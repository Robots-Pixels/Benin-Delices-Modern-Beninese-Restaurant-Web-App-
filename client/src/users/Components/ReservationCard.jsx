  ...
  return (
    ...
    '>
        <div className='flex mx-auto flex-col w-full 
            ...
            sm:w-3/5
            sm:border-[12px] sm:rounded-[20px] sm:rounded-r-none sm:px-16 sm:py-16 sm:border-r-0 md:px-20'>
                ...
                <button className='bg-primary text-white p-2 rounded hover:bg-opacity-85 w-full sm:text-2xl'>Réserver</button>
                </form>

            </div>

            <div className='sm:border-black sm:border-[12px] sm:rounded-[20px] sm:rounded-l-none sm:border-l-0 sm:py-16 sm:w-2/5 sm:bg-'>
